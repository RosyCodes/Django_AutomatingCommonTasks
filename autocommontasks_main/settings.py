"""
Django settings for autocommontasks_main project.
...
ROOT_URLCONF = 'autocommontasks_main.urls'
...
WSGI_APPLICATION = 'autocommontasks_main.wsgi.application'
...
# this saves to our current root directory
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# Message configuration for INFO, ERROR or SUCCESS messages
MESSAGE_TAGS = {
